...
- **Conceitual:**
  ...
  - [**v0.9**][13] — Composição com classe Segment para representar os lados
...
- **Estrutural:**
  ...
  - [**v0.7.2**][11] — Simplificação de Lógica em Triangle e TriangleUtils
...
[13]: https://github.com/jspneto-csharp-estudos/comparacao-triangulos/tree/v0.9/Project "v0.9"